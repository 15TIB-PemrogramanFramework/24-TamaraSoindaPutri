				...
				<div class="carousel-inner" role="listbox">
					<div class="item active"><br><br><br><br><br>
						<h2 class="nino-sectionHeading">
							<span class="nino-subHeading">Our Customer Service </span>
						</h2>
	</header><!--/#header-->
...
<center>
    ...
    <h1 class="mt-4 mb-3">Form Customer Area
      <small></small>
    </h1>
    
        <?php $this->session->flashdata('service') ?>
        <form action="<?php echo $aksi; ?>" method="POST" enctype="multipart/form-data">
        
          <div class="form-group">

          <label>Area</label>
				<select class="form-control select2" name="area_cust" style="width: 100%;">
						<?php foreach ($service as $key => $value) { ?>
						<option value="<?php echo $value->id_cs; ?>"><?php echo $value->area;?></option>
						<?php } ?>
				</select>
