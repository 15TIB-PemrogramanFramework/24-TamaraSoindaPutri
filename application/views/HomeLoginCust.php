			...
			<section id="nino-slider" class="carousel slide container" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item"><br><br><br><br><br>
						...
						<a href="<?php echo site_url('Home/shopCust')?>" class="nino-btn">Learn more</a>
					</div>
					<div class="item"><br><br><br><br><br>
						<h2 class="nino-sectionHeading">
							<span class="nino-subHeading"> Contact US </span>
						</h2>
						<a href="<?php echo site_url('Home/contactCust'); ?>" class="nino-btn">Learn more</a>
					</div>
				</div>
