...
<body data-target="#nino-navbar">
	...
	<section id="nino-story">
		<div class="container">
			...
			<p><b>Area Pekanbaru</b></p>
			<p>
				<ul>
					<li>Telp/WA : 081274638293</li>
					<li>Line : BulakanAG01</li>
				</ul>
			</p>
			<p><b>Area Tembilahan</b></p>
			<p>
				<ul>
					<li>Telp/WA : 082375849305</li>
					<li>Line : BulakanAG02</li>
				</ul>
			</p>
			<p><b>Area Sumatera Barat</b></p>
			<p>
				<ul>
					<li>Telp/WA : 081384849300</li>
					<li>Line : BulakanAG03</li>
				</ul>
			</p>
