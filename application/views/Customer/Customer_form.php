...
<form action="<?php echo site_url('$aksi'); ?>" method="POST">
	...
	<div class="form-group">
		...
		<input type="text" name="pass_cust" class="form-control" placeholder="Password" 
		required value="<?php echo $pass_cust; ?>">
	</div>
	<div class="form-group">
		<label>Nama Depan : </label>
		<input type="text" name="nama_depan" class="form-control" placeholder="Nama Depan" 
		required value="<?php echo $nama_depan; ?>">
	</div>
	<div class="form-group">
		<label>Nama Belakang : </label>
		<input type="text" name="nama_belakang" class="form-control" placeholder="Nama Belakang" 
		required value="<?php echo $nama_belakang; ?>">
	</div>
	<div class="form-group">
		<label>No HP : </label>
